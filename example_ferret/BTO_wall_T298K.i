[Mesh]
  ...
  #[../]
  #[top_outlet]
  #  type = ParsedGenerateNodeset #ParsedGenerateSideset
  #  input = gen
  #  expression = 'z>0.9 & (x-25)^2+(y-25)^2<10'
  #  new_nodeset_name = 200
  #[../]
[]
...
[Functions]
  ...
  [./afm_tip_voltage]
    type = ParsedFunction
    value = '5*exp(-((x-25)^2 + (y-25)^2)/5^2)'
    #symbol_names = 'V0 x0 y0 r'
    #symbol_values = '5.0 25.0 25.0 5.0'  # 5V tip centered at (25,25) with ~5 nm radius
  [../]
[]
